...
namespace Store.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            var appUser1 = user as Store.Models.ApplicationUser;
            Username = userName;

            Input = new InputModel
            {
                PhoneNumber = phoneNumber,
                FirstName = appUser1?.FirstName,
                LastName = appUser1?.LastName,
                Email = email 
            };
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var appUser = user as Store.Models.ApplicationUser;
            if (appUser != null)
            {
